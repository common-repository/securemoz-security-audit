...
== Changelog ==
= 1.0.6 =
* Update WordPress core files speed scan engine match 4.4.1
* Security Fix:  explicitly HTTP (no TLS) thanks to seclists.org
* Enhancement: Added better handling of Google Safe Browsing API.
* Improvement: Optimized database query with URL scan.
* Fix: Resolved issue with some admin links.
